...
├─ Automate multi-step flows          → Workflows (references/events.md#workflow-execution)
├─ Monitor workflows in real-time     → WebSocket (references/architecture.md#websocket-real-time-updates)
